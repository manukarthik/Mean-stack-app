•	Developed a MEAN stack web app which uses MongoDB, Angular 4 and Angular material front-end, Express JS as middleware and Node JS as a server-side scripting language. 
